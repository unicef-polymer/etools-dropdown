...
declare const EtoolsDropdown_base: {
    new (...args: any[]): {
...
export declare class EtoolsDropdown extends EtoolsDropdown_base {
    ...
    updated(changedProperties: any): void;
    _selectedAndOptionsChanged(_selected: any, _options: any): void;
    _setSelectedItem(selected?: any, selectedItem?: any): void;
    _getAutoValidate(): boolean | undefined;
    _getItemFromOptions(value: any): any;
    _notFoundOptionAndUrlChanged(notFoundOption: number | null, url: string): void;
    ...
    _invalidInputChanged(e: CustomEvent): void;
    _searchChanged(e: CustomEvent): void;
    _selectedValueChanged(e: CustomEvent): void;
}
export {};
