...
export declare const MissingOptionsMixin: <T extends MixinTarget<LitElement>>(superClass: T) => {
    new (...args: any[]): {
         ...
         */
        requestMissingOptions(notFoundValues: any[]): void;
        /**
         * Handle missing option request response
         * @param response
         */
        handleMissingOptionsReqResponse(response: CustomEvent): void;
        /**
         * Handle missing options request error
         * @param errorResponse
         */
        handleMissingOptionsReqError(errorResponse: CustomEvent): void;
        /**
         * Check if request missing option functionality can be used
         * @param url
         * @returns {boolean}
         */
        shouldRequestMissingOption(url: string): boolean;
        /**
         * Check if option received from missing options request is valid
         * @param optionObj
         * @returns {boolean|*}
         */
        isValidOption(optionObj: any): any;
        /**
        ...
        hideSearch: boolean;
        hideClose: boolean;
        focusedAtLeastOnce: boolean;
        shownOptionsLimit: number;
        _shownOptionsCount: number;
        ...
        debounce(fn: any, time: any): (...args: any) => void;
        _setFitInto(): void;
        setFitInto(): void;
        _setResetSizeHandler(): void;
        _isUndefined(prop: any): boolean;
        resetIronDropdownSize(): void;
        _noOptions(): boolean;
        _menuBtnIsDisabled(disabled: boolean, readonly: boolean): boolean;
        resetInvalidState(): void;
        readonly noOptionsAvailable: boolean | undefined;
        ...
        _computeEqualToShownOptionsLimit(shownOptionsLimit: any): any;
        readonly showNoSearchResultsWarning: boolean;
        _onDropdownOpen(): void;
        _onDropdownClose(): void;
        _setDropdownWidth(): void;
        _setFocusTarget(): void;
        _setPositionTarget(): void;
        _getIronDropdown(): import("@polymer/iron-dropdown").IronDropdownElement;
        _getIronDropdownContent(): any;
        _getOptionsList(): any;
        _getSearchox(): any;
        _getPaperInputContainer(): any;
        _openMenu(_e: Event): void;
        _closeMenu(_e: Event): void;
        _setDropdownMenuVerticalOffset(): void;
        _preserveListScrollPosition(): void;
        onInputFocus(e: Event): void;
        notifyDropdownResize(): void;
        isIEBrowser(): boolean;
        arrayIsNotEmpty(arr: string | any[]): number | false;
        _getErrorMessage(message: any, invalid: any): any;
        onShowMore(e: CustomEvent<any>): void;
        optionValue: string;
        optionLabel: string;
        ...
        _capitalizeString(string: string): string;
        getTranslation(key: string): any;
        readonly renderRoot: Element | DocumentFragment;
        attributeChangedCallback: (name: string, old: string | null, value: string | null) => void;
        requestUpdate: (name?: PropertyKey | undefined, oldValue?: unknown) => Promise<unknown>;
