...
declare const EsmmOptionsList_base: {
    new (...args: any[]): {
        optionValue: string;
        optionLabel: string;
 ...
 */
export declare class EsmmOptionsList extends EsmmOptionsList_base {
     ...
     * @private
     */
    _itemSelected(e: CustomEvent, item: any): void;
    /**
     *
     * @param item
     * @returns {*}
     ...
     * @private
     */
    _getSelectedClass(item: any): string;
    /**
     ...
     * @private
     */
    _getSelectedClassSingle(item: any): "" | "iron-selected";
    /**
     ...
     * @private
     */
    _getSelectedClassMulti(item: any): "" | "iron-selected";
    _getItemValueByOptionValue(item: any): any;
    _selectedValuesChanged(e: CustomEvent): void;
}
export {};
