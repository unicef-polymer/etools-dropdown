...
declare const EtoolsDropdownMulti_base: {
    new (...args: any[]): {
        ...
        _getIronDropdown(): import("@polymer/iron-dropdown/iron-dropdown.js").IronDropdownElement;
    ...
    new (...args: any[]): {
        ...
        handleMissingOptionsReqResponse(response: CustomEvent<any>): void;
        handleMissingOptionsReqError(errorResponse: CustomEvent<any>): void;
 ...
 */
export declare class EtoolsDropdownMulti extends EtoolsDropdownMulti_base {
     ...
     */
    _setSelectedItems(selectedValues: any[]): void;
     ...
     */
    _notFoundOptionsAndUrlChanged(notFoundOptions: any[], url: string): void;
    ...
    _noSelectedValues(selectedValues: any[]): boolean;
    _noSelectedItems(selectedItems: any[]): boolean;
    _selectedValuesToString(): void;
    _getElementTitle(selectedItems: any[]): string;
    _getCloseBtnText(closeText: string, language: string): any;
    _searchChanged(e: CustomEvent): void;
