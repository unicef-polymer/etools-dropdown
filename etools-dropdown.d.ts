...
declare function DropdownRequiredMixins<T extends new (...args: any[]) => {}>(base: T): T & DropdownRequiredMixinsConstructor;

interface DropdownRequiredMixinsConstructor {
  new(...args: any[]): DropdownRequiredMixins;
}

export {DropdownRequiredMixinsConstructor};

interface DropdownRequiredMixins {
}

/**
 * `etools-dropdown`
 */
declare class EtoolsDropdown extends
